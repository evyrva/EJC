package com.epam.javalab.codingbat.array_1;
...
public class Solution {
    ...
    public int[] midThree(int[] nums) {
        int[] res = new int[]{nums[nums.length/2-1],nums[nums.length/2],nums[nums.length/2+1]};
        return res;
    }
    ...
    public int maxTriple(int[] nums) {
        int[] res = new int[]{nums[0],nums[nums.length/2],nums[nums.length-1]};
    ...
    public int[] frontPiece(int[] nums) {
        return Arrays.copyOfRange(nums, 0 , (nums.length>2 ? 2 : nums.length));
    }

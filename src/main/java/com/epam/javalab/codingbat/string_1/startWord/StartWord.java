package com.epam.javalab.codingbat.string_1.startWord;
...
public class StartWord {
    ...
    public String startWord(String str, String word) {
        ...
        if (word.length() == 1) return str.charAt(0)+"";
        if (str.length()>0 && str.substring(1).startsWith(word.substring(1))) return str.substring(0,word.length());
        return "";
    }
}

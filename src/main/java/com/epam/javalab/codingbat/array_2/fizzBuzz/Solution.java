package com.epam.javalab.codingbat.array_2.fizzBuzz;
...
public class Solution {
     ...
     * than the usual version since you have to allocate and index into an array instead of just printing, and we
